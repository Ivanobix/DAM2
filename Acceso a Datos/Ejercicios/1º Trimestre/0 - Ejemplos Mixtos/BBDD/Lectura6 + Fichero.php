		...
		<?php
			...
			if(!$link = mysqli_connect("localhost", "root", "")) {
				...
				if(!mysqli_select_db($link, "empresa")) {
					...
					$aEscribir = "La suma de habitantes de $nombresPaises es: $sumHabitantes habitantes. De estas ciudades tienen metro: $sumMetro ciudades.";
					file_put_contents("sumaHabitantes.txt", $aEscribir);
